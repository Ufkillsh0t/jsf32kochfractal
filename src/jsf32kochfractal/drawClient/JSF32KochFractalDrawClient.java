 ...
 * @author tim
 */
public class JSF32KochFractalDrawClient extends Application {
    ...
    private KochManagerDrawClient kochManager;
    ...
    public void start(Stage primaryStage) {
        ...
        labelCalcText.setMaxSize(400, 100);
    ...
    public void drawWhiteEdge(final Edge e) {
